k8s-nfd-watcher is a custom Kubernetes controller that will restart pods based on external devices being connected or disconnected (ie. webcams, 3D Printers). 
